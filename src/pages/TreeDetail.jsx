...
export default function TreeDetail() {
  ...
  useEffect(() => {
    ...
    // Show animation if user arrived via QR scan
    const isQRScan =
      !document.referrer ||
  ...
  const handleAddImage = async (url) => {
    ...
    try {
      ...
      const res = await addTreeImage(id, {
        image_url: url,
          ...
          {heroImage && !imgFailed
            ...
            : (
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, #1a3618, #2d5a27)'
                }}
              >
                🌳
              </div>
      ...
      <div className="max-w-5xl mx-auto px-4 pt-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="absolute -right-4 -top-5 text-6xl opacity-10">
              O₂
            </div>
        ...
        {tree.interesting_facts && (
          ...
          <RevealSection delay={0.1}>
            ...
            >
              ...
              <div className="absolute top-0 right-0 text-8xl opacity-10 leading-none">
                💡
              </div>
